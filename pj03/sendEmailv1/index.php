...
try {
    ...
    $mail->Username = 'fostter2@gmail.com';// SMTP username
    $mail->Password = 'mkhuvahftrotibhj'; // SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;// Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` also accepted
    $mail->Port = 587; // TCP port to connect to
    $mail->CharSet = 'UTF-8';
    //Recipients
    $mail->setFrom('fostter2@gmail.com', '06.Phạm Đức Anh');

    $mail->addReplyTo('fostter2@gmail.com', '06.Phạm Đức Anh');
      
    $mail->addAddress('fostter2@gmail.com'); // Add a recipient
    ...
    // Mail body content 
    $bodyContent = '<p>Thân gửi Tân sinh viên <b></b></h1>'; 
    $bodyContent .= '<p>Trường Đại học Thủy lợi xin chúc mừng Em đã trở thành Tân sinh viên ngành <b></b> của Khoa Công nghệ thông tin. </p>'; 
